...
<body class="main-body">
    ...
    <div class="logo position-absolute">
        ...
        <div class="overlay-navigation">
            <nav role="navigation" class="marker">
                <ul>
                    ...
                    <li><a href="game.html">MusicQuiz</a></li>
        ...
        <div class="container card text-center pt-5">

            <h1 class="marker mb-5">Vous avez apprécié ce jeu?</h1>
            <h2 class="mt-2 mb-4">Retrouvez mes autres projets sur</h2>
            ...
            <p class="mt-3">Désirée Besnard - Copyright © <?php echo date("Y") ?></p>
